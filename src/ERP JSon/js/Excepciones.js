...
//Excepcion se ha intentado crear objeto abstracto
function AbstractException(obj){
    this.name = "AbstractException";
    this.message = "El objeto "+obj+" no puede instanciarse al ser abstracto";
}
AbstractException.prototype = new BaseException();
AbstractException.prototype.constructor = AbstractException;
